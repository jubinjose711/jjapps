  ...
  $.fn.foundationSelect = function() {
    ...
    if (!$('.custom-dropdown-area').length) {
      ...
      return this.each(function () {
        ...
        newButton = '<div class="custom-dropdown-area" data-orig-select="#' + selectId + '"' + (multiple ? ' data-multiple="true"' : '') + '><a data-dropdown="select-' + selectId + '" class="custom-dropdown-button">' + selectPrompt + '</a> \
